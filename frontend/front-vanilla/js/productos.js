...
function getProductos() {
  $.ajax({
    url: "http://144.22.57.2:8083/api/auto/all",
    type: "GET",
    dataType: "json",
...
function borrarElemento(id) {
  $.ajax({
    url: "http://144.22.57.2:8083/api/auto/" + id,
    type: "DELETE",
    dataType: "json",
...
function crearProducto(e) {
  ...
  d.addEventListener("submit", (e) => {
    ...
    $.ajax({
        url: "http://144.22.57.2:8083/api/auto/new",
        type:"POST",
        contentType: "application/json",
        data: dataToSend,
        success: function (){
...
function editarProducto(e) {
  ...
  d.addEventListener("submit", (e) => {
    ...
    let data={
       ...
       let dataToSend = JSON.stringify(data);
    $.ajax({
        url: "http://144.22.57.2:8083/api/auto/update",
        type:"PUT",
        contentType: "application/json",
        data: dataToSend,
        success: function (){
